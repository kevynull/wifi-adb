...
import pro.fren.adb.R;
import pro.fren.adb.receiver.ADBReceiver;
...
public class ADB
{
	...
	private static final String START_ADB = "start adbd";
	private static final String STOP_ADB = "stop adbd";
